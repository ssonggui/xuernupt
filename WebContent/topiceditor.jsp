...
<body class="home">
  ...
  <c:if test="${cookie.loginname.value==null }">
	...
	<div class="container">
	<form action="<%=request.getContextPath()%>/addtopic" method="post">
	<div class="row">
...
<div class="col-md-12 ">
			...
			<div class="btn-toolbar" data-role="editor-toolbar" data-target="#editor">
			      ...
			      <div class="btn-group">
			        <a class="btn btn-success dropdown-toggle" data-toggle="dropdown" title="字体大小"><i class="icon-text-height"></i>&nbsp;<b class="caret"></b></a>
					  ...
					  <li><a data-edit="fontSize 6"><font size="6">大</font></a></li>
			          <li><a data-edit="fontSize 5"><font size="5">中</font></a></li>
			          <li><a data-edit="fontSize 3"><font size="3">小</font></a></li>
			          <li><a data-edit="fontSize 1"><font size="1">超小</font></a></li>
			          </ul>
			      </div>
				  
			      <div class="btn-group">
			        <a class="btn btn-danger dropdown-toggle" data-toggle="dropdown" title="字体颜色"><i class="icon-font"></i>&nbsp;<b class="caret"></b></a>
			          <ul class="dropdown-menu">
			          
					  <li><a data-edit="forecolor red" style="color:#FF0000"> 红</a></li>
					  <li><a data-edit="forecolor #900000" style="color:#900000"> 暗红</a></li>
					  <li><a data-edit="forecolor black" style="color:black"> 黑</a></li>
					  <li><a data-edit="forecolor yellow" style="color:#FFFF00"> 黄</a></li>
					  <li><a data-edit="forecolor blue" style="color:blue"> 蓝</a></li>
					  <li><a data-edit="forecolor gray" style="color:#C0C0C0"> 灰</a></li>
					  <li><a data-edit="forecolor green" style="color:green"> 绿</a></li>
			          </ul>
			      </div>				  
			      <div class="btn-group">
			        <a class="btn btn-warning dropdown-toggle" data-toggle="dropdown" title="背景颜色"><i class="icon-desktop"></i>&nbsp;<b class="caret"></b></a>
			          <ul class="dropdown-menu">

					  <li><a data-edit="backcolor red" style="color:#FF0000"> 红</a></li>
					  <li><a data-edit="backcolor #900000" style="color:#900000"> 暗红</a></li>
					  <li><a data-edit="backcolor black" style="color:black"> 黑</a></li>
					  <li><a data-edit="backcolor yellow" style="color:#FFFF00"> 黄</a></li>
					  <li><a data-edit="backcolor blue" style="color:blue"> 蓝</a></li>
					  <li><a data-edit="backcolor gray" style="color:#C0C0C0"> 灰</a></li>
					  <li><a data-edit="backcolor green" style="color:green"> 绿</a></li>
			          </ul>
			      </div>					  
			      ...
			      <div class="btn-group">
			        <a class="btn btn-success" data-edit="formatblock pre" title="代码块 "><i class="icon-book"></i></a>
			...
			<a href="<%=request.getContextPath()%>/course" class="btn btn-info pull-right">返回</a>
			</div>
</div>
</div>
	</form>
...
<script>
  $(function(){
    ...
    $('#btnSave').bind('click', function () {    	
        ...
        if($("#content").val().length<1 && $("#title").val().length<1 ){
        	alert("无标题或无内容！！！");
        	return;
        }
