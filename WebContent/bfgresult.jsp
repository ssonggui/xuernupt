...
<head>
	...
	<script type="text/javascript">
		$(function(){
			$("#content").keydown(function(){
				...
				if(f){
					 ...
					 location.href  = encodeURI("<%=request.getContextPath()%>/bfg/editor?precontent=" + $("#content").val()) ;
				};
		...
		var addfriend = function addfriend(field){
			location.href  = "<%=request.getContextPath()%>/bfg/search/addfriend?who=" + field.value ;
		};
		
		var delfriend = function addfriend(field){
			location.href  = "<%=request.getContextPath()%>/bfg/search/delfriend?who=" + field.value ;
		};
	</script>
